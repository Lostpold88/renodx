...
void comp_main() {
  ...
  float _118 = (tint_color.x * mad(_89, 0.047379501163959503173828125f, mad(_87, 0.3395229876041412353515625f, _85 * 0.613097012042999267578125f))) * _21_m0[2u].w;
  float _119 = (tint_color.y * mad(_89, 0.013452400453388690948486328125f, mad(_87, 0.916354000568389892578125f, _85 * 0.070193700492382049560546875f))) * _21_m0[2u].w;
  float _120 = (tint_color.z * mad(_89, 0.86981499195098876953125f, mad(_87, 0.1095699965953826904296875f, _85 * 0.020615600049495697021484375f))) * _21_m0[2u].w;
  bool _121 = _119 < _120;

...
void main(
  ...
  if (!RENODX_OVERRIDE_BRIGHTNESS) {
    r0.rgb = ApplyToneMapBT2020(r0.rgb, untonemapped, RENODX_PEAK_WHITE_NITS / (cb0[24].y * 100.f));
    r0.xyz = cb0[24].yyy * r0.xyz;
  } else {
    r0.rgb = ApplyToneMapBT2020(r0.rgb, untonemapped, RENODX_PEAK_WHITE_NITS / RENODX_DIFFUSE_WHITE_NITS);

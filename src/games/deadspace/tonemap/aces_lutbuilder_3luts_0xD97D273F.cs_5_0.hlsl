...
// ---- Created with 3Dmigoto v1.4.1 on Mon Jun 22 04:18:25 2026
...
void main(uint3 vThreadID: SV_DispatchThreadID) {
  ...
  r2.xyz = t1.SampleLevel(s0_s, r0.xwz, 0).xyz;
  r2.xyz = r2.xyz + -r1.xyz;
  r1.xyz = cb0[10].xyz * r2.xyz + r1.xyz;
  r0.xyz = t2.SampleLevel(s0_s, r0.xwz, 0).xyz;
  r0.xyz = r0.xyz + -r1.xyz;
  r0.xyz = cb0[11].xyz * r0.xyz + r1.xyz;
  r0.w = 1;
